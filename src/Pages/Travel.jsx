  ...
  return (
    <MDBContainer>
          ...
          <div className={`row d-flex ${styles.containerslider}`}>
            ...
            >
              <h1 className={styles.h1}>
                {" "}
                {dictionary?.title} <br /> {dictionary?.title1}
              </h1>
              <h4 className={`mb-4 mt-3 text-xs-center `}>
                {dictionary?.description} <br /> {dictionary?.description2}
              </h4>
      ...
      <div>
        <div>
          <CardTravel
            pais={dictionary?.countrie1}
            cidade1="Boston"
            cidade1p={dictionary?.city1p}
            cidade2={dictionary?.city2}
            cidade2p={dictionary?.city2p}
            cidade3="Chicago"
            cidade3p={dictionary?.city3p}
            cidade4="Los Angeles"
            cidade4p={dictionary?.city4p}
            image1={imagecard1}
            image2={img2}
            image3={img3}
            image4={img4}
          ...
          <CardTravel
            pais={dictionary?.countrie2}
            cidade1="Toronto"
            cidade1p={dictionary?.city5p}
            cidade2="Montreal"
            cidade2p={dictionary?.city6p}
            cidade3="Victoria"
            cidade3p={dictionary?.city7p}
            cidade4="Vancouver"
            cidade4p={dictionary?.city8p}
            image1={img5}
            image2={img6}
            image3={img7}
            image4={img8}
          ...
          <CardTravel
            pais={dictionary?.countrie3}
            cidade1={dictionary?.city9}
            cidade1p={dictionary?.city9p}
            image1={img9}
            cidade2="Liverpool"
            cidade2p={dictionary?.city10p}
            image2={img10}
            cidade3="Brigha"
            cidade3p={dictionary?.city11p}
            image3={img11}
            cidade4="Cambridge"
            cidade4p={dictionary?.city12p}
            image4={img12}
          ></CardTravel>
          <CardTravel
            pais={dictionary?.countrie4}
            cidade1="Madrid"
            cidade1p={dictionary?.city13p}
            image1={img13}
            cidade2="Barcelona"
            cidade2p={dictionary?.city14p}
            image2={img14}
            cidade3="Sevilha"
            cidade3p={dictionary?.city15p}
            image3={img15}
            cidade4="Granada"
            cidade4p={dictionary?.city16p}
            image4={img16}
          ></CardTravel>
          <CardTravel
            pais={dictionary?.countrie5}
            cidade1="Paris"
            cidade1p={dictionary?.city17p}
            image1={img17}
            cidade2="Marselha"
            cidade2p={dictionary?.city18p}
            image2={img18}
            cidade3="Lyon"
            cidade3p={dictionary?.city19p}
            image3={img19}
            cidade4="Nice"
            cidade4p={dictionary?.city20p}
            image4={img20}
          ></CardTravel>
        </div>
      </div>
