      ...
      <main>
        <section className=" ">
          <div className={`container  ${aboutstyle.marginslide}`}>
            <div
              className={`row  d-flex justify-content-center ${styles.containerslider}`}
            >
              <div
                className={`col-lg-4 col-md-6 align-self-center mb-md-0 mb-4 pt-3 ${styles.textslider}`}
              >
                ...
                <div className={`m-0 ${styles.divbuttons}`}>
                  <a
                    path=""
                    className={`button btn btn-primary button-primary d-md-inline-block d-block mb-md-0 mb-2 mr-md-2 disabled ${styles.buttons} ${styles.button1}`}
                    style={{ backgrounColor: "#b23cfd" }}
                  >
                    {dictionary?.button}
                  </a>
                </div>
        ...
        <section className="pt-4">
          <h2
            className={` ${aboutstyle.storyh2}  mt-5  text-center text-uppercase font-weight-bold`}
          >
            {dictionary?.aboutus}
          </h2>
          <div className={` ${aboutstyle.storyp2} p-2 mt-3`}>
            <p className={`mt-2 d-flex ${aboutstyle.storytext} text-center`}>
