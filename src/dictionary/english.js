const dictionary = () => ({
  ...
  travel: {
    ...
    city1p:
      "Located in the state of Massachusetts, Boston is recognized for being the birthplace of American independence. Culturally diverse, the city has a significant number of Irish and Portuguese immigrants.",
    city2: "New York",
    city2p:
      "New York is the largest city in the United States. Of the local population, 40% is foreign and more than 80 different languages ​​are spoken. No wonder New York is home to several companies and organizations around the world.",
    city3p:
      "Known as the “City of the Winds”, Chicago surprised by its diversity. Bringing together the largest number of parks and squares in the United States and internationally recognized for the quality and modernity of its architecture, the city combines nature and development.",
    city4p:
      "Los Angeles is the most important city in California, being a leader in the production of films, series and music. With numerous beaches, sights and skyscrapers, it is a city full of attractions for the most diverse styles.",

    countrie2: "Canada",
    city5p:
      "Cosmopolitan, multicultural and with a busy nightlife, activities are not lacking in this metropolis, which in addition to these qualities, has a high level of quality of life and safety. It has a first world educational structure and is one of the most multicultural cities on the planet.",
    city6p:
      "It is a major industrial, commercial and university center. The city is considered one of the safest cities in the world, with highly educated people and the highest concentration of students in North America.\
    Montreal is also the second largest French-speaking city in the world.",
    city7p:
      "Victoria is located on Vancouver Island and is the capital of the state of British Columbia. The city has a European feel and is known as “The City of Gardens” due to the beautiful and colorful gardens that are scattered throughout the city.",
    city8p:
      "It has a lot of cultural diversity and was elected in 2018 as the best city to live in North America and the 5th best in the world. Mercer (an international consulting firm) was responsible for this ranking and took into account factors such as personal safety, stability, crime levels and local law enforcement performance.",
    ...
    city17p:
      "Considered one of the most romantic cities in the world, Paris is undoubtedly a destination that has a lot to offer. In addition to a breathtaking architectural ensemble, imposing monuments and flowering gardens, first-class cuisine is sure to win over any traveler.",
    city18p:
      "Innovative architectural buildings. Excellent hospitality and cuisine. And 2,600 years of historic heritage. This is Marseille, the second largest – and oldest – city in France. Located 776 miles from the capital, it appeared in 600 BC, by the work of the Greeks.",
    city19p:
      "Studying abroad in Lyon is living in a city that offers all the privileges of life in France, but without the stress typical of a capital. With just over 500,000 inhabitants, Lyon is situated in the historic Rhône-Alpes region and is the third largest city in the country.",
    city20p:
      "Coastal city, located in the south of France, is one of the most sought after destinations in the country. Sunny all year round, it receives an average of 4 million tourists throughout the year, who go after its beautiful beaches and landscapes.",
