const dictionary = () => ({
  ...
  travel: {
    ...
    city6p:
      "É um grande centro industrial, comercial e universitário.A cidade é considerada uma das cidades mais seguras do mundo, com um povo super educado e com a maior concentração de estudantes da América do Norte.\
    ...
    city17p:
      "Considerada uma das cidades mais românticas do mundo, Paris é sem dúvidas um destino que tem muito a oferecer. Além de um conjunto arquitetônico de tirar o fôlego, monumentos imponentes e jardins floridos, a gastronomia de primeira com certeza conquistar qualquer viajante.",
    city18p:
